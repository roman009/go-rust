...
microk8s helm3 upgrade service-discoverer --install --set image.tag=$COMMIT_HASH --set image.pullPolicy=IfNotPresent --atomic --timeout=1m infrastructure/apps/service-discoverer/ || exit 1
